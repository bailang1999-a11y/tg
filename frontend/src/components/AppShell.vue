...
const nav = [
  ...
  { label: '导入账号', path: '/import', icon: '⇪' },
  { label: '网络节点', path: '/network', icon: '◈' },
  { label: '目标群组', path: '/targets', icon: '◎' },
  { label: '私信群发', path: '/workflow', icon: '✦' },
  { label: '一键修改资料', path: '/profile-assets', icon: '▣' },
  { label: '任务', path: '/tasks', icon: '☷' },
  { label: '日志', path: '/logs', icon: '☰' },
  { label: '监听设置', path: '/outreach-sync', icon: '◌' },
