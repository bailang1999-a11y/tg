...
services:
  frontend:
    build:
      context: "https://github.com/bailang1999-a11y/TG-Marketing-Assistant.git#${APP_GIT_REF:-v1.0.52}"
      dockerfile: frontend/Dockerfile
      args:
        APP_VERSION: "${APP_VERSION:-1.0.52}"
  ...
  gateway:
    build:
      context: "https://github.com/bailang1999-a11y/TG-Marketing-Assistant.git#${APP_GIT_REF:-v1.0.52}:backend"
      args:
        APP_VERSION: "${APP_VERSION:-1.0.52}"
