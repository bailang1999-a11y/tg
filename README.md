...
services:
  frontend:
    build:
      context: "https://github.com/bailang1999-a11y/TG-Marketing-Assistant.git#${APP_GIT_REF:-v1.0.25}"
  ...
  gateway:
    build:
      context: "https://github.com/bailang1999-a11y/TG-Marketing-Assistant.git#${APP_GIT_REF:-v1.0.25}:backend"
      args:
        APP_VERSION: "${APP_VERSION:-1.0.25}"
    ...
    environment:
      APP_VERSION: "${APP_VERSION:-1.0.25}"
      LISTENER_ACCOUNT_CHECK_CONCURRENCY: "${LISTENER_ACCOUNT_CHECK_CONCURRENCY:-4}"
      APP_ENV: "production"
      APP_PORT: "8080"
